...
- [ ] **Phase 1: Lexer, Parser & AST Diagnostics** - Tokenizer, Pratt expression parser, and AST definition with diagnostic inspection.
...
- [ ] 01-02: Pratt expression parser and grammar construction
- [ ] 01-03: Diagnostic reporting and AST inspection CLI harness
...
Plans:
- [ ] 03-01: Backend IR lowering for arithmetic and functions
- [ ] 03-02: Control flow lowering and native object emission/linking
...
Plans:
- [ ] 04-01: CLI command interface (`build`, `run`, flags)
- [ ] 04-02: Contiguous array primitives and vector math intrinsics
...
|-------|----------------|--------|-----------|
| 1. Lexer, Parser & AST Diagnostics | 0/3 | Not started | - |
